...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="/data/gpfs/projects/punim2198/hkanagalinga/DOCUMENT_HAYSTACK/output/hybrid_results", help="Output directory for results")
